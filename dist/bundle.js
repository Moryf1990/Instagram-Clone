...
var toggleButton = (0, _jquery2.default)('.toggle-button');
var url = 'http://small-tiyfe.herokuapp.com/collections/morrisfriedman';
var imageButton = (0, _jquery2.default)('.image-button');
var input = (0, _jquery2.default)('.input');
var text = (0, _jquery2.default)('.text');
var photoBooth = (0, _jquery2.default)('.photobooth');
...
imageButton.on('click', function (e) {
	...
	_jquery2.default.post(url, { url: newInput, caption: newText }, function (result) {
		photoBooth.append('<img src="' + result.url + '">' + '<div">' + result.caption + '</div>');
		input.val('');
		text.val('');
	}, 'json');
